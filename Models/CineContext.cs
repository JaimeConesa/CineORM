...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;database=cine;user=root", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.4.32-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
            ...
            entity.HasMany(d => d.Directors).WithMany(p => p.Peliculas)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<int>("PeliculaId")
                            .HasColumnType("int(11)")
                            .HasColumnName("pelicula_id");
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<int>("PeliculaId")
                            .HasColumnType("int(11)")
                            .HasColumnName("pelicula_id");
                        j.IndexerProperty<int>("EstudioId")
                            .HasColumnType("int(11)")
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<int>("PeliculaId")
                            .HasColumnType("int(11)")
                            .HasColumnName("pelicula_id");
                        j.IndexerProperty<int>("GeneroId")
                            .HasColumnType("int(11)")
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<int>("PeliculaId")
                            .HasColumnType("int(11)")
                            .HasColumnName("pelicula_id");
                        j.IndexerProperty<int>("ProductorId")
                            .HasColumnType("int(11)")
        ...
        modelBuilder.Entity<PeliculaPremio>(entity =>
        {
            ...
            entity.Property(e => e.PeliculaId)
                .HasColumnType("int(11)")
                .HasColumnName("pelicula_id");
            entity.Property(e => e.PremioId)
                .HasColumnType("int(11)")
                .HasColumnName("premio_id");
        ...
        modelBuilder.Entity<ResenasCritico>(entity =>
        {
            ...
            entity.Property(e => e.Comentario)
                .HasColumnType("text")
                .HasColumnName("comentario");
            entity.Property(e => e.CriticoId)
                .HasColumnType("int(11)")
                .HasColumnName("critico_id");
            entity.Property(e => e.Fecha)
                .HasDefaultValueSql("current_timestamp()")
                .HasColumnType("timestamp")
                .HasColumnName("fecha");
